...
set OPT=-O2 -g0 -Wall -Wextra -mcpu=cortex-x3+nomops -mtune=cortex-x3 -flto=thin -ffunction-sections -fdata-sections -fomit-frame-pointer -fno-unwind-tables -fno-asynchronous-unwind-tables -fvisibility=hidden -Wno-unused-parameter -Wno-sign-compare
