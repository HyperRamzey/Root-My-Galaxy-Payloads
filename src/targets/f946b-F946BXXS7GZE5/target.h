...
#define BUILD_VARIANT_LABEL "f946b-F946BXXS7GZE5-app"
...
/* mm_struct slab: objsize=0x400, 32 objs/slab, order-3 (from /proc/slabinfo) */
...
/*
 * ===========================================================================
 * FOLD5 (SM-F946B) OFFSET DERIVATION NOTES
 *
 * All offsets below were derived from the recovered vmlinux.elf of the
 * F946BXXS7GZE5 firmware (kernel 5.15.189-android13-8-33404244).
 * Symbols were extracted via llvm-nm on the vmlinux-to-elf recovered ELF.
 *
 * Verified against vmlinux.nm (build/f946b-F946BXXS7GZE5/work/):
 *   - All function offsets confirmed by exact symbol match
 *   - Data offsets confirmed by nm + ELF field reads
 *   - ashmem_compat_ioctl confirmed via file_operations+0x58 pointer read
 *   - nfulnl_logger name/object confirmed via struct field reads
 *
 * Differences from dm3q (S23 Ultra, same SoC/kernel):
 *   - KMALLOC_CACHES_OFF:      0x020644f8 (dm3q: 0x020641f8, +0x300)
 *   - ANON_PIPE_BUF_OPS_OFF:   0x01e7f4e0 (dm3q: 0x01e7f1e0, +0x300)
 *   - ASHMEM_FOPS_OFF:         0x0200d538 (dm3q: 0x0200d238, +0x300)
 *   - SLIDE_NFULNL_LOGGER_NAME_OFF:   0x01d5dd0e (dm3q: 0x01d5dbd6)
 *   - SLIDE_NFULNL_LOGGER_OBJECT_OFF: 0x02a91e48 (dm3q: 0x022f2a08)
 *
 * SLIDE_PSELECT_WORD_SHIFT=3 inherited from dm3q (identical kernel build).
 * Pending runtime verification on device.
 *
 * See docs/PORTING.md and docs/SM-F946B.md for the full porting procedure.
 * ===========================================================================
 */
...
/* Non-suffixed symbols used by the payload code */
...
#define OVERRIDE_CREDS (KIMAGE_TEXT_BASE + OVERRIDE_CREDS_OFF)
